...
Web SerialとXBee UARTは現在のHEPTA XBeeペアと同じ **38400 baud** です。機体側・地上局側XBeeは
`AP=0`（Transparent mode）、`BD=5`（38400 baud）に設定してください。30バイトのパケット形式と換算式は参照Flight Softwareと同一です。
